    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/admin/purchasing/dashboard"
            className="inline-flex items-center px-3.5 py-2 border border-zinc-200 bg-white hover:bg-zinc-50 text-zinc-800 dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-200 dark:hover:bg-zinc-800 text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer"
          >
            📊 대시보드 (Dashboard)
          </Link>
          {!isReadOnly && (
