...
export default async function PurchasingLandedCostCasesPage() {
      ...
      <div className="flex justify-between items-center">
        <div>
          <div className="flex items-center gap-2 text-xs text-zinc-500 mb-1">
            ...
            <span>/</span>
            <span className="text-zinc-900 dark:text-white font-medium">Landed Cost Operational Hub</span>
          </div>
          <h1 className="text-xl font-bold text-zinc-955 dark:text-white">Landed Cost 정산 케이스 (Purchasing Consolidate Cases)</h1>
          <p className="text-xs text-zinc-550 dark:text-zinc-400">
            동일/복수 선적 건(Shipments)에 대한 운송, 관세, 통관 수수료 등의 공통비용을 취합하고 CBM, 무게, 가액 비율 기준으로 SKU별 최종 입고 단가(Unit Landed Cost)를 확정합니다.
          </p>
        </div>
        <Link
          href="/admin/purchasing/landed-cost/new"
