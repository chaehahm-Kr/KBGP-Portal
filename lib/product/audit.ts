...
> = {
  ...
  container_40ft_qty: { label: "40ft 컨테이너 적재 박스수", section: "로지스틱스" },
  container40ftQty: { label: "40ft 컨테이너 적재 박스수", section: "로지스틱스" },
  container_40ft_weight: { label: "40ft 컨테이너 총무게 (kg)", section: "로지스틱스", type: "weight_kg" },
  container40ftWeight: { label: "40ft 컨테이너 총무게 (kg)", section: "로지스틱스", type: "weight_kg" },
  container_40ft_cbm: { label: "40ft 컨테이너 총 CBM", section: "로지스틱스" },
  container40ftCbm: { label: "40ft 컨테이너 총 CBM", section: "로지스틱스" },
  container_40fthc_qty: { label: "40HQ 컨테이너 적재 박스수", section: "로지스틱스" },
  container40fthcQty: { label: "40HQ 컨테이너 적재 박스수", section: "로지스틱스" },
  container_40fthc_weight: { label: "40HQ 컨테이너 총무게 (kg)", section: "로지스틱스", type: "weight_kg" },
  container40fthcWeight: { label: "40HQ 컨테이너 총무게 (kg)", section: "로지스틱스", type: "weight_kg" },
  container_40fthc_cbm: { label: "40HQ 컨테이너 총 CBM", section: "로지스틱스" },
  container40fthcCbm: { label: "40HQ 컨테이너 총 CBM", section: "로지스틱스" },
